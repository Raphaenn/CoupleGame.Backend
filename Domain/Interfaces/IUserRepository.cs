...
public interface IUserRepository
{
    ...
    Task<IReadOnlyList<User>> GetUsersByParams(Guid userId, string city, string sexuality, string sexualOrientation, double? height, double? weight, int sizePlusOne, CancellationToken ct);
